...
<body>
	...
	<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
		...
		<ul>
			<li><a href=<c:url value="/" />><i class="bi bi-house-door"></i>
					HOME</a></li>
			<li><a href=<c:url value="/venda/incluir" />>Realizar uma
					compra</a></li>
			<li><a href=<c:url value="/venda/listar" />>Lista de Vendas</a></li>
		</ul>
		<footer id="rodape">
